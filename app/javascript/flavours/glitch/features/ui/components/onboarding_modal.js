...
const PageSix = ({ admin, domain }) => {
  ...
  return (
    <div className='onboarding-modal__page onboarding-modal__page-six'>
      ...
      {adminSection}
      <p><FormattedMessage id='onboarding.page_six.github' defaultMessage='{domain} runs on Mastodon VA-11 Hall-A Edition. Mastodon VA-11 Hall-A is a friendly {fork} of {glitchsoc}. Mastodon VA-11 Hall-A Edition is fully compatible with all Mastodon apps and instances. Mastodon VA-11 Hall-A Edition is free open-source software. You can report bugs, request features, or contribute to the code on {github}.' values={{ domain, fork: <a href='https://en.wikipedia.org/wiki/Fork_(software_development)' target='_blank' rel='noopener'>fork</a>, glitchsoc: <a href='https://github.com/glitch-soc/mastodon' target='_blank' rel='noopener'>Mastodon Glitch Edition</a>, github: <a href='https://github.com/Pixeliz3d/mastodon' target='_blank' rel='noopener'>GitHub</a> }} /></p>
